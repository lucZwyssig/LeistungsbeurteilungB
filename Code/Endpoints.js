...
app.post('/login', (req, res) => {
  ...
  if (!req.is('json')) {
    res.sendStatus(415)
    console.error("wrong media format given")
    return
  }
  ...
  if (!isEmail) {
    ...
    console.error("not an email given")
    return
  }
  // check type
...
app.post('/tasks', verify, (req, res) => {
  ...
  if (!req.is('json')) {
    ...
    res.sendStatus(406)
    console.log("schema not followed")
  } else {
...
app.put('/tasks/:id', verify, (req, res) => {
  ...
  if (!req.is('json')) {
    ...
    console.error("schema not followed")
  } else if (taskIndex === -1) {
    res.sendStatus(404)
    console.error("not found")
  } else {
